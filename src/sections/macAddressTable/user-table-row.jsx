...
// import {sendV,askCA,sendCA,sendCC,sendTV,sendFW,sendTC,askUrl,sendHBT,sendSIP,sendPWD,sendSSID,sendFota,sendPWD1,fn.modeNone,sendSSID1,sendLight,sendReset,fn.modeTest,modeTest2,sendFotaUrl} from 'src/_mock/macAddress';
     ...
     if(mode==="")
      {
        ...
        if(mode==="tm1")
        {
          fn.modeTest(m.MacID,m.SocketNumber,sessionStorage.getItem("name"));
        }
        else{
