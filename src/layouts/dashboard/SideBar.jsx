            ...
            <ul className="metismenu" id="menu" >
               ...
               <li className="mt-1">
                ...
                <li  className="ra mt-1">
                      <NavItem path="/trafficSingle" icon={ <i className="fa-solid fa-fan" />} title='TrafficSingle'/>
                 </li>
                <li  className="ra mt-1">
                      <NavItem path="/trafficTriple" icon={ <i className="fa-solid fa-fan" />} title='TrafficTriple'/>
                 </li>
                ...
                <li  className="ra mt-1">
                 ...
                 {/* <li className="mt-1">
                    ...
                    <li  className="ra mt-0">
                            <NavItem  path="/loginLogs" icon={ <i className="fa-solid fa-arrow-right-to-bracket" />} title='Login Logs'/>
                            </li>
                  <li>
